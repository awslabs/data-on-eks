...
|------|-------------|------|---------|:--------:|
| <a name="input_emr_spark_operator_config"></a> [emr\_spark\_operator\_config](#input\_emr\_spark\_operator\_config) | Helm configuration for Spark Operator with EMR Runtime | `any` | `{}` | no |
