...
# Print EMR on EKS specific outputs
print_status "EMR on EKS Virtual Clusters created:"
cd "$TERRAFORM_DIR/_local"
terraform output -json emr_on_eks 2>/dev/null | jq '.' || echo "No EMR virtual clusters found"
cd -
