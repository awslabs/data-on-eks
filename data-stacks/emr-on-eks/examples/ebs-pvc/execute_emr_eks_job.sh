...
#--------------------------------------------
# Deploy EBS Storage Class and PVC for Driver
#--------------------------------------------
echo "Deploying StorageClass and Driver PVC..."
kubectl apply -f "$SCRIPT_DIR/ebs-storageclass-pvc.yaml"
...
#--------------------------------------------
# Execute Spark job with EBS PVC configuration
#--------------------------------------------
echo "Submitting EMR on EKS job with EBS PVC storage..."
