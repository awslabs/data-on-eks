...
def main():
    ...
    and writes the result to a new Iceberg table.
    """
    # ==============================================================================
    ...
    try:
        # ==============================================================================
        # 1. EXTRACT: Read data from Iceberg and PostgreSQL
        # ==============================================================================
        ...
        # Read cat profiles directly from PostgreSQL
        print("Reading from PostgreSQL table: 'cats'")
        cats_profiles_df = (
            spark.read
            .format("jdbc")
            .option("url", DB_URL)
        ...
        print(f"Successfully read {cats_profiles_df.count()} cat profiles from PostgreSQL.")


        # ==============================================================================
        # 2. TRANSFORM: Perform aggregations and joins
        # ==============================================================================
        ...
        # ==============================================================================
        # 3. LOAD: Write the final summary table to Iceberg
        # ==============================================================================
