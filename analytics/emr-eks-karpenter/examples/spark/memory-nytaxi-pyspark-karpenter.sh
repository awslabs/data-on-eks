      ...
      "applicationConfiguration": [
          {
            ...
            "properties": {
              "spark.kubernetes.driver.podTemplateFile":"'"$SPARK_JOB_S3_PATH"'/pod-templates/memory-driver-pod.yaml",
              "spark.kubernetes.executor.podTemplateFile":"'"$SPARK_JOB_S3_PATH"'/pod-templates/memory-executor-pod.yaml",
