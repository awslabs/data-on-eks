    ...
    "applicationConfiguration": [
        {
          ...
          "properties": {
            ...
            "spark.kubernetes.driver.volumes.persistentVolumeClaim.data.mount.path": "/data1",

            "spark.kubernetes.executor.volumes.persistentVolumeClaim.data2.options.claimName": "OnDemand",
            "spark.kubernetes.executor.volumes.persistentVolumeClaim.data2.options.storageClass": "emr-eks-karpenter-ebs-sc",
            "spark.kubernetes.executor.volumes.persistentVolumeClaim.data2.options.sizeLimit": "50Gi",
            "spark.kubernetes.executor.volumes.persistentVolumeClaim.data2.mount.path": "/data1",
            "spark.kubernetes.executor.volumes.persistentVolumeClaim.data2.mount.readOnly": "false",
