...
# 1. emr-containers-role-analytics-client
# 2. emr-containers-role-analytics-driver
...
if __name__ == '__main__':
    ...
    patch_role("emr-containers-role-analytics-driver", args.namespace, driverRoleRules, args.no_prompt)
    patch_role("emr-containers-role-analytics-client", args.namespace, clientRoleRules, args.no_prompt)
