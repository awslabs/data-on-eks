...
| <a name="input_enable_grafana"></a> [enable\_grafana](#input\_enable\_grafana) | Enable Open source Grafana addon | `bool` | `false` | no |
| <a name="input_enable_yunikorn"></a> [enable\_yunikorn](#input\_enable\_yunikorn) | Enable Apache YuniKorn Scheduler | `bool` | `false` | no |
| <a name="input_name"></a> [name](#input\_name) | Name of the EKS Cluster | `string` | `"emr-roadshow"` | no |
