...
def _neuron_compile_extracted_graphs():
    try:
        ...
        from torch_neuronx.parallel_compile.neuron_parallel_compile import CacheUrl
        from torch_neuronx.parallel_compile.neuron_parallel_compile import parallel_compile
    except ImportError:
        raise ImportError(
