...
def chat_completion_example(messages, model="meta-llama/Llama-3.2-1B-Instruct", temperature=0.7, max_tokens=100):
    try:
...
def streaming_chat_completion_example(messages, model="meta-llama/Llama-3.2-1B-Instruct", temperature=0.7, max_tokens=100):
    try:
