---
sidebar_position: 2
sidebar_label: Monitoring EMR on EKS
---
...
In this [example](https://github.com/awslabs/data-on-eks/tree/main/analytics/emr-eks-amp-amg), you will provision the following resources required to run Spark Jobs using EMR on EKS, as well as monitor spark job metrics using **Amazon Managed Prometheus** and **Amazon Managed Grafana**.
