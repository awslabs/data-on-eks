...
| <a name="module_trino_hive_addon"></a> [trino\_hive\_addon](#module\_trino\_hive\_addon) | aws-ia/eks-blueprints-addon/aws | ~> 1.1.1 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_catalog_type"></a> [catalog\_type](#input\_catalog\_type) | Trino catalog type | `string` | `"hive"` | no |
