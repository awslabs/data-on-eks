...
Checkout the [documentation website](https://awslabs.github.io/data-on-eks/docs/job-schedulers/self-managed-airflow) to deploy this pattern and run sample tests.
...
| <a name="module_airflow_irsa_webserver"></a> [airflow\_irsa\_webserver](#module\_airflow\_irsa\_webserver) | ../../../workshop/modules/terraform-aws-eks-data-addons/irsa | n/a |
| <a name="module_airflow_irsa_worker"></a> [airflow\_irsa\_worker](#module\_airflow\_irsa\_worker) | ../../../workshop/modules/terraform-aws-eks-data-addons/irsa | n/a |
